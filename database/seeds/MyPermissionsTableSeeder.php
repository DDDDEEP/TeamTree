...
class MyPermissionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permission->display_name = '新增节点角色';
        ...
        $permission->display_name = '删除节点角色';
        $permission->group_id = 4;
        $permission->save();
